...
public class DataUpdater {
	 ...
	 * @param contraseña Contraseña del usuario logueado para guardar sus nuevos datos.
	 ...
	 */
	public static void guardarUsuario(String usuario, String contraseña, String filepath, int id){
		...
		try {
			...
			if(id == 1){
				bw.write(usuario+","+contraseña+",0,50,50,100,"+(0));
			}
			else {
				bw.write("\n" + usuario + "," + contraseña + ",0,50,50,100," + (id - 1));
			}
	 ...
	 *                    los datos del usuario.
	 */
	public static void actualizarUsuario(String usuario, String contraseña, int coordenada, int conocimientos,
										 int moral, int hp, String filepath, int id){
		ArrayList<String> registro = FileReader.leerArchivo(filepath);
		BufferedWriter bw = null;
		FileWriter fichero = null;
		registro.set(id,usuario+","+contraseña+","
